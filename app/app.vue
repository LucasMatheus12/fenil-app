  ...
  <div class="container mx-auto max-w-6xl">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <!-- Wrapper fixo; img sem object-fit -->
        <div class="absolute bottom-10 right-0 w-full h-[178px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard1.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-5 left-1/2 -translate-x-1/2 w-[237px] h-[139.7px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard2.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-5 left-1/2 -translate-x-1/2 w-[239px] h-[163px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard3.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-5 left-1/2 -translate-x-1/2 w-[239px] h-[159px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard4.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-5 left-1/2 -translate-x-1/2 w-full h-[164px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard5.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-1 left-1/2 -translate-x-1/2 w-[230px] h-[167px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard6.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
      ...
      <div class="relative bg-[rgba(13,13,14,1)] rounded-lg border-[1.5px] pt-[32px] px-[24px] border-[rgba(221,221,221,0.05)] shadow-[inset_1px_1px_0_0_rgba(16,14,19,1)] transition-colors h-[354px] overflow-hidden">
        ...
        <div class="absolute bottom-0 right-0 w-full h-[178px] z-20 overflow-hidden flex items-end justify-center">
          <img src="/images/imgCard7.svg" alt="" class="w-full h-auto pointer-events-none select-none">
        </div>
        <img src="/images/maskCard.svg" alt="" class="absolute bottom-0 right-0 w-full h-[178px] object-cover z-10">
      </div>
